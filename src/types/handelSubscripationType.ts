...
export interface BaseSubscripationType  {
  transaction_id:string;
  operationType?: "renew" | "upgrade";
  admin_id: number;
  amount: number;
...
export interface RenewSubscripationType extends BaseSubscripationType{}
...
export type HandelSubscripationType =  RenewSubscripationType | UpgradeSubscripationType;
